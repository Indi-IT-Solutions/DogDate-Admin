            ...
            <Row>
                <Col lg={12}>
                    <div className="d-flex justify-content-between align-items-center mb-3">
                        <h5 className="text-dark mb-0">Dog Characters</h5>
                    ...
                    <div className="scrollable-table">
                        <DataTable
                            ...
                            noDataComponent="No Characters found"
                        />
                    </div>
                </Col>
            </Row>
            ...
            <Modal className="edit_modal" show={showModal} onHide={handleCloseModal} centered>
                <Form onSubmit={handleSave}>
                    <Modal.Header closeButton>
                        <Modal.Title>{editBreed ? "Edit Character" : "Add Character"}</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
            ...
            <Modal className="modal_Delete" show={showDeleteModal} onHide={() => setShowDeleteModal(false)} centered>
                <Modal.Body>
                    <div className="modaldelete_div text-center">
                        ...
                        <h3>Are You Sure?</h3>
                        <p>You will not be able to recover the deleted character!</p>
                    </div>
